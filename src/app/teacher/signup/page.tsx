  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      ...
      >
        ...
        <h1 className="text-3xl font-extrabold text-pink-600 drop-shadow-lg text-center mb-2">Teacher Sign Up</h1>
        <p className="text-lg text-blue-700 font-semibold text-center mb-4">Create your account to start teaching road safety!</p>
        <Input
          type="email"
          placeholder="Email"
          value={email}
        ...
        <div className="text-center text-sm mt-2">
          Already have an account? <Link href="/teacher/login" className="text-blue-600 hover:underline font-bold">Login</Link>
        </div>
      </form>
    </div>
  );
